...
void print(int array[], int size, string name, double expected) {
	double actual = calculate_average(array, size);
	...
	cout << "The arithmetical mean of vector elements is " << actual << ".\n";
	cout << "----------------------------------------------------" << endl;
}
